...
public class AdapterTopOffersViewMore extends RecyclerView.Adapter<AdapterTopOffersViewMore.MyViewHolder> {
    ...
    public AdapterTopOffersViewMore(Context context, ArrayList<ModelTopOffers> arrayList)
    {
    ...
    {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_top_offer_more, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.ll_row.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putString("from","activityTopOffer");
                editor.commit();
